...
include DIR . '/core/models/resetPasswordModel.php';
                            ...
                            <div class="auth-content my-auto">
                                ...
                                <form class="custom-form mt-4" method="post">
                                    <div class="mb-3 <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                                        <label for="userpassword" class="form-label">Новый пароль</label>
                                    ...
                                    <div class="mb-3">
                                        <button class="btn btn-primary w-100 waves-effect waves-light" type="submit">Отправить</button>
                                    </div>
                                </form>
