                            ...
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    ...
                                    <div class="p-2 mt-4">
                                        ...
                                        <p>Подтвердите вашу электронную почту <span class="fw-bold"><?php echo $_GET['email']; ?></span>, нажав на кнопку</p>
                                        <div class="mb-3">
                                            <span class="text-danger"><?php echo $useremail_err; ?> </span>
                                        </div>
                                        <div class="mt-4">
                                            <form method="post">
                                                <button type="submit" class="btn btn-primary w-10">Подтвердить Email</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
